...
var _user$project$Message$FormMsg = {ctor: 'FormMsg'};
var _user$project$Message$RequestMsg = {ctor: 'RequestMsg'};
...
var _user$project$Web_Model_Page$Page = function (a) {
	return {message: a};
};

var _user$project$Model_Models$new = {
	page: {message: 'none'}
};
var _user$project$Model_Models$Models = function (a) {
	return {page: a};
};
...
var _user$project$Web_Routing_Route$NotFound = {ctor: 'NotFound'};
var _user$project$Web_Routing_Route$take = function (maybePagePath) {
	return A2(_elm_lang$core$Maybe$withDefault, _user$project$Web_Routing_Route$NotFound, maybePagePath);
};
var _user$project$Web_Routing_Route$isSuccess = function (maybePagePath) {
	var _p0 = _user$project$Web_Routing_Route$take(maybePagePath);
...
var _user$project$Model_Params$updateRender = F2(
	function (update, params) {
		return _elm_lang$core$Native_Utils.update(
			params,
			{render: update});
	});
var _user$project$Model_Params$updateModels = F2(
	function (update, params) {
		return _elm_lang$core$Native_Utils.update(
			params,
			{models: update});
	});
var _user$project$Model_Params$updatePath = F2(
	function (location, params) {
		return _elm_lang$core$Native_Utils.update(
			params,
			{
				currentPagePath: _user$project$Web_Routing_Route$build(location),
				locationHistory: {ctor: '::', _0: location, _1: params.locationHistory}
			});
	});
var _user$project$Model_Params$Params = F4(
	function (a, b, c, d) {
		return {currentPagePath: a, locationHistory: b, models: c, render: d};
	});
var _user$project$Model_Params$new = F2(
	function (location, startRender) {
		return A4(
			_user$project$Model_Params$Params,
			...
			_user$project$Model_Models$new,
			startRender);
	});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Location History'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Current Page'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _user$project$Web$view = function (params) {
	return A2(_user$project$Web_View_LayoutView$render, params, params.render);
};
var _user$project$Web$update = F2(
	function (msg, params) {
		...
		switch (_p0.ctor) {
			...
			case 'UrlChange':
				return A2(_user$project$Web_Routing_Router$routing, _p0._0, params);
			default:
				return {ctor: '_Tuple2', _0: params, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
...
var _user$project$Web$main = A2(
	...
	_user$project$Message$UrlChange,
	{init: _user$project$Web$init, view: _user$project$Web$view, update: _user$project$Web$update, subscriptions: _user$project$Web$subscriptions})();

var Elm = {};
Elm['Web'] = Elm['Web'] || {};
if (typeof _user$project$Web$main !== 'undefined') {
    _user$project$Web$main(Elm['Web'], 'Web', undefined);
}
